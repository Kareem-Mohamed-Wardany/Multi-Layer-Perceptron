...
C1p = C12 = C13 = C2p = C21 = C23 = C3p = C31 = C32 = 0 # For Conf Matrix
...
def createNetwork(Numberofinput, Layers, NeuronsPerLayer, NumberofOutputs): # Create the Whole Network
    hiddenLayers = CreateHidden(Numberofinput, Layers, NeuronsPerLayer) # Create all Hidden layers
    network = hiddenLayers 
    outputLayer = CreateOutput(NumberofOutputs, NeuronsPerLayer[-1]) # Create output layer
